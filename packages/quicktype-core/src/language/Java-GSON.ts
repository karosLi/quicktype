...
export class JavaGSONTargetLanguage extends TargetLanguage {
    constructor() {
        super("Java-GSON", ["java-gson"], "java");
    }

    protected getOptions(): Option<any>[] {
        return [
            javaGSONOptions.useList,
            javaGSONOptions.justTypes,
            javaGSONOptions.dateTimeProvider,
            javaGSONOptions.acronymStyle,
            javaGSONOptions.packageName,
            javaGSONOptions.lombok,
            javaGSONOptions.lombokCopyAnnotations
        ];
    }
...
abstract class JavaDateTimeProvider {
    constructor(protected readonly _renderer: JavaGSONRenderer, protected readonly _className: string) { }
...
export class JavaGSONRenderer extends ConvenienceRenderer {
    ...
    constructor(
        ...
        protected readonly _options: OptionValues<typeof javaGSONOptions>
    ) {
...
export class JacksonGSONRenderer extends JavaGSONRenderer {
    constructor(
        targetLanguage: TargetLanguage,
        renderContext: RenderContext,
        options: OptionValues<typeof javaGSONOptions>
    ) {
